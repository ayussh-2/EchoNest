...
function Search({ playOnTap, songs, toggleSearch }) {
    ...
    return (
        ...
        >
            <div className="flex relative flex-col items-center justify-center bg-white p-10 w-auto rounded-xl">
                <button
                    className="absolute top-5 right-5"
                    onClick={toggleSearch}
                >
                    <i className="fa-regular fa-circle-xmark text-2xl hover:text-red-500 duration-150 active:scale-75"></i>
                </button>
                <div className="mt-10">
                    <input
                        type="text"
                    ...
                    {searchResults.length > 0 ? (
                        ...
                        <h1 className="font-poppins mt-10">
                            No Results found!
                        </h1>
                    )}
                </div>
